...
public class V8ScriptEngineTest
{
    ...
    public void testEngineBindings() throws ScriptException
    {
		...
		assertNull(g.get("test"));
		assertNull(g.put("test", "test"));
    ...
    public void testJavaObjects() throws ScriptException, NoSuchMethodException
    {
    	...
    	assertNull(engineScope.put("name", "test"));
    	assertNull(engineScope.put("person", person));
    	...
    	assertNull(this.eng.eval("person.test"));
    	...
    	// Named query
    	assertTrue("'name' in person", (Boolean) this.eng.eval("'name' in person"));
    	assertTrue("'hello' in person", (Boolean) this.eng.eval("'hello' in person"));
    	assertFalse("'test' in person", (Boolean) this.eng.eval("'test' in person"));

    	// Named deleter
    	assertEquals("test", person.name);
    	assertFalse("delete person.name;", (Boolean) this.eng.eval("delete person.name;"));
    	assertFalse("delete person['name'];", (Boolean) this.eng.eval("delete person['name'];"));
    	assertEquals("test", person.name);
    ...
    public void testJavaArray() throws ScriptException, NoSuchMethodException
    {
		...
		assertNull(this.eng.eval("array[-1]"));
		try {
		...
		// Indexed query
		assertTrue("index query 0", (Boolean) this.eng.eval("0 in array"));
		assertTrue("index query 1", (Boolean) this.eng.eval("2 in array"));
		assertFalse("index query -1", (Boolean) this.eng.eval("-1 in array"));
		assertFalse("index query -3", (Boolean) this.eng.eval("3 in array"));
    ...
    public void testCreateAndSetArray() throws ScriptException {
        ...
        assertNull(arr.toStringArray()[3]);
